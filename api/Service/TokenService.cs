...
namespace api.Service
{
    public class TokenService : ITokenService
    {
        ...
        public TokenService(IConfiguration config)
        {
            ...
            //from .env file, for when deploying
        }
        public string CreateToken(AppUser user)
        {
            ...
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                ...
                Issuer = Environment.GetEnvironmentVariable("JWT_ISSUER"), // for when deploying, moved to .env file
                Audience = Environment.GetEnvironmentVariable("JWT_AUDIENCE") // for when deploying
            };
