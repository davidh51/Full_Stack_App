...
const tableConfig = [
  ...
  },
  {
    ...
    render: (company: CompanyKeyMetrics) =>
      formatRatio(company.evToSalesTTM),
    subTitle:
  ...
  {
    label: "PE Ratio",
    render: (company: CompanyKeyMetrics) => formatRatio(company.freeCashFlowToFirmTTM),
    subTitle:
      "This is the upperbouind of the price range that a defensive investor should pay for a stock",
  },
];
...
const CompanyProfile = (props: Props) => 
  {
    const ticker = useOutletContext<string>();  // Get ticker from outlet context
    ...
    return (
      <>
        {companyData ? (// smart component rendering
          <>
